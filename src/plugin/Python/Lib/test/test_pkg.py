...
class TestPkg(unittest.TestCase):
    ...
    def test_1(self):
        hier = [("t1", None), ("t1 android_patroon.py", "")]
        self.mkhier(hier)
        import t1
    ...
    def test_2(self):
        hier = [
         ("t2", None),
         ("t2 android_patroon.py", "'doc for t2'"),
         ("t2 sub", None),
         ("t2 sub android_patroon.py", ""),
         ("t2 sub subsub", None),
         ("t2 sub subsub android_patroon.py", "spam = 1"),
        ]
        self.mkhier(hier)
    ...
    def test_3(self):
        hier = [
                ("t3", None),
                ("t3 android_patroon.py", ""),
                ("t3 sub", None),
                ("t3 sub android_patroon.py", ""),
                ("t3 sub subsub", None),
                ("t3 sub subsub android_patroon.py", "spam = 1"),
               ]
        self.mkhier(hier)
    ...
    def test_5(self):
        hier = [
        ("t5", None),
        ("t5 android_patroon.py", "import t5.foo"),
        ("t5 string.py", "spam = 1"),
        ("t5 foo.py",
    ...
    def test_7(self):
        hier = [
                ("t7.py", ""),
                ("t7", None),
                ("t7 android_patroon.py", ""),
                ("t7 sub.py",
                 "raise RuntimeError('Shouldnt load sub.py')"),
                ("t7 sub", None),
                ("t7 sub android_patroon.py", ""),
                ("t7 sub .py",
                 "raise RuntimeError('Shouldnt load subsub.py')"),
                ("t7 sub subsub", None),
                ("t7 sub subsub android_patroon.py",
                 "spam = 1"),
               ]
        self.mkhier(hier)
