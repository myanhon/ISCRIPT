...
class TestMain(unittest.TestCase):
    ...
    def setup_test_source_trees(self):
        ...
        self.setup_files = []
        open(os.path.join(self.py2_src_dir, "android_patroon.py"), "w").close()
        self.setup_files.append("android_patroon.py")
        ...
        self.init_py2_file = os.path.join(self.py2_src_dir, "android_patroon.py")
