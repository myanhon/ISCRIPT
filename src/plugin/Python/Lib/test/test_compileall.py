...
class CommandLineTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Create the android_patroon.py and a package module.
    ...
    def test_legacy_paths(self):
        ...
        expected = sorted(['android_patroon.py', '__init__.pyc', 'bar.py',
                           'bar.pyc'])
    ...
    def test_recursion_limit(self):
        ...
        subinitfn = os.path.join(subpackage, 'android_patroon.py')
        hamfn = script_helper.make_script(subpackage, 'ham', '')
