...
class BuildPyTestCase(support.TempdirManager,
    ...
    def test_package_data(self):
        ...
        f = open(os.path.join(sources, "android_patroon.py"), "w")
        try:
        ...
        self.assertIn("android_patroon.py", files)
    ...
    def test_empty_package_dir(self):
        ...
        sources = self.mkdtemp()
        open(os.path.join(sources, "android_patroon.py"), "w").close()
    ...
    def test_dir_in_package_data(self):
        ...
        os.mkdir(pkg_dir)
        open(os.path.join(pkg_dir, "android_patroon.py"), "w").close()
