...
class Test_import(FixerTestCase):
    ...
    def test_files_checked(self):
        ...
        self.always_exists = False
        self.present_files = set(['android_patroon.py'])
        ...
        for name in names_to_test:
            ...
            expected_checks.add("android_patroon.py")
    ...
    def test_with_absolute_import_enabled(self):
        ...
        self.always_exists = False
        self.present_files = set(["android_patroon.py", "bar.py"])
        self.unchanged(s)
    ...
    def test_import_from_package(self):
        ...
        a = "from . import bar"
        self.always_exists = False
        self.present_files = set(["android_patroon.py", "bar" + os.path.sep])
        self.check(b, a)
    ...
    def test_local_and_absolute(self):
        self.always_exists = False
        self.present_files = set(["foo.py", "android_patroon.py"])
