...
class PycacheTests(unittest.TestCase):
    ...
    def test_package___cached__(self):
        ...
        # Touch the android_patroon.py
        with open(os.path.join('pep3147', 'android_patroon.py'), 'w'):
            pass
        ...
        init_pyc = importlib.util.cache_from_source(
            os.path.join('pep3147', 'android_patroon.py'))
...
class TestSymbolicallyLinkedPackage(unittest.TestCase):
    ...
    def setUp(self):
        ...
        init_file = os.path.join(self.tagged, 'android_patroon.py')
        ...
        assert os.path.isfile(os.path.join(self.package_name, 'android_patroon.py'))
    ...
    def test_symlinked_dir_importable(self):
        ...
        assert os.path.exists(os.path.join(self.package_name, 'android_patroon.py'))
...
class ImportTracebackTests(unittest.TestCase):
    ...
    def _setup_broken_package(self, parent, child):
        ...
        os.mkdir(pkg_path)
        # Touch the android_patroon.py
        init_path = os.path.join(pkg_path, 'android_patroon.py')
